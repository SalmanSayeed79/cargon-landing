...
export default function Landing() {
  ...
  return (
    <Paper>
      ...
      >
        <Typography variant="h4" sx={{cursor:"pointer"}}>Cargon</Typography>
        <Box
          sx={{
        ...
        >
          <Typography variant="h6" sx={{cursor:"pointer"}}>Home</Typography>
          <Typography variant="h6" sx={{cursor:"pointer"}}>Products</Typography>
      ...
      >
        ...
        >
          ...
          <Box sx={{ width: {xs:"100vw",md:"50vw"},display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }} data-aos="fade-right">
            ...
            <a href="https://cargon-medpilot.web.app/" target="_blank" style={{textDecoration:"none"}}><Button variant="contained" sx={{backgroundColor:"#673ab7"}}><Typography sx={{fontSize:{xs:"24px",md:"36px"},fontWeight:"bold"}} >VISIT MEDPILOT </Typography></Button></a>
            </Box>
          </Box>
        </Box>
        ...
        >
          ...
          <Box sx={{width:{xs:"80vw",md:"40vw"},display:"flex",flexDirection:"column",alignItems:{md:"flex-end"},justifyContent:"flex-end",margin:"2vh 0",marginRight:{md:"4vw"}}} >
            ...
            <a href="https://cargonproduction.web.app/" target="_blank" style={{textDecoration:"none"}}><Button variant="contained" sx={{backgroundColor:"#009688"}}><Typography sx={{fontSize:{xs:"24px",md:"36px"},fontWeight:"bold"}}>VISIT MILLHOUSE </Typography></Button></a>
            </Box>
          </Box>
        ...
        >
          ...
          <Box sx={{ width: {xs:"100vw",md:"50vw"},display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }} data-aos="fade-right">
            ...
            <Box sx={{display:"flex",alignItems:"center",justifyContent:{xs:"center",md:"flex-start"},flexWrap:"wrap", margin:"2vh 0",width: {xs:"80vw",md:"40vw"}}}>
            <a href="https://cargon-medchant.web.app/" target="_blank" style={{textDecoration:"none"}}><Button variant="contained" sx={{backgroundColor:"#ff5722"}}><Typography sx={{fontSize:{xs:"24px",md:"36px"},fontWeight:"bold"}}>VISIT MEDCHANT </Typography></Button></a>
            </Box>
          </Box>
        </Box>
        ...
        >
          ...
          <Box sx={{width:{xs:"80vw",md:"40vw"},display:"flex",flexDirection:"column",alignItems:{md:"flex-end"},justifyContent:"flex-end",margin:"2vh 0",marginRight:{md:"4vw"}}} >
            ...
            <Box sx={{display:"flex",flexWrap:"wrap",justifyContent:{md:"flex-end"}, margin:"2vh 0",width: {xs:"80vw",md:"40vw"},marginRight:{md:"4vw"}}}>
            <a href="https://cargon-meddepot.web.app/" target="_blank" style={{textDecoration:"none"}}><Button variant="contained" sx={{backgroundColor:"#ff9800"}}><Typography sx={{fontSize:{xs:"24px",md:"36px"},fontWeight:"bold"}}>VISIT MEDDEPOT </Typography></Button></a>
            </Box>
          </Box>
      ...
      >
        ...
        <Box sx={{ width: {xs:"100vw",md:"50vw"},display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center" }} data-aos="fade-right">
          ...
          <Box sx={{display:"flex",alignItems:"center",justifyContent:{xs:"center",md:"flex-start"},flexWrap:"wrap", margin:"2vh 0",width: {xs:"80vw",md:"40vw"}}}>
          <a href="https://cargon-apothecary.web.app/" target="_blank" style={{textDecoration:"none"}}><Button variant="contained" sx={{backgroundColor:"#2196f3"}}><Typography sx={{fontSize:{xs:"24px",md:"36px"},fontWeight:"bold"}}>VISIT APOTHECARY </Typography></Button></a>
          </Box>
        </Box>
      </Box>
